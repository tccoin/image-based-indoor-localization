...
def customPredictSiamese_tf2(
    ...
    print('# of test frames: ', test_results.shape[0])
    print('# of map frames: ', train_results.shape[0])
    ...
    for i in p(range(test_results.shape[0])):
        ...
        start = time.time()
        max_score_id = search.find_nearest(test_results[i])
