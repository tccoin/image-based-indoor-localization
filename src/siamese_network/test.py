...
def add_argument(parser):
    ...
    # testing
    parser.add_argument('--testing_name', default='chess', help='name of training', action='store')
    ...
    parser.add_argument('--output_data_dir', default='model/chess/', help='location of outputs', action='store')
    parser.add_argument('--input_data_dir', default='data/chess/tfrecord2/', help='location of training tfrecords file', action='store')
    ...
    parser.add_argument('--num_candidate', default=5, help='Number of candidate zones from the Siamese comparison',
                        action='store')
    parser.add_argument('--threshold_angle', default=30, help='Threshold of angle to segment image pairs',
                        action='store')
    parser.add_argument('--threshold_dist', default=1, help='Threshold of angle to segment image pairs',
                        action='store')
