...
switch dataset_name
    case 'TUM'
       ...
       %% Edit path to data here
       driverpath = '...\data\ethl1_local';
    ...
    case '7scenes'
        ...
        FILENAME_BASE = [driverpath subdataset '\' subdataset '_train__siamese_FXPAL_output'];
        
        
        for i = 1 : 1
            filename = [FILENAME_BASE '.h5py'];
            pose_ID_groudtruth{i} = h5read(filename,'/posenet_x_label');
            pose_ID_predict{i} = h5read(filename,'/posenet_x_predicted');
        end
