...
if __name__ == '__main__':
    ...
    #     threshold_dist = 0.01
    #     dataset_dir = '/net/patel-gpu/ssd2/jingwei_semantic_relocalization/data'
    #     save_dir = '/net/patel-gpu/ssd2/jingwei_semantic_relocalization/data_filter'
    #     #   End of parameter setting
    #
    #
    #     image_file_dir = dataset_dir+ '/' + ('%02d/'%index)
    #     depth_file_dir = dataset_dir + '/' + ('%02d/' % index)
    #     image_save_dir = save_dir + '/sequences/' + ('%02d/img/' % index)
    #     depth_save_dir = save_dir + '/sequences/' + ('%02d/depth/' % index)
    #
    #     if not os.path.exists(save_dir):
    #         os.mkdir(save_dir)
    #
    #     text_file = os.path.join(dataset_dir, ('%02d.txt'%index))
    #     images, depth, poses, otherinfo = parse_text_file_quaternion(text_file)
    #     images, depth, poses, otherinfo = sparse_data_gen(images, depth, poses, otherinfo, threshold_dist) ## filtering data
    #
    #
    #     text_file = os.path.join(save_dir, ('%02d.txt' % index))
    #     save_data(text_file, images, depth, poses, otherinfo, image_save_dir, depth_save_dir, image_file_dir, depth_file_dir)

    print('All the process is finished')
    ############## write script to save text file
